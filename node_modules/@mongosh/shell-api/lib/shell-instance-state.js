...
class ShellInstanceState {
    ...
    async getDefaultPrompt() {
        var _a, _b;
        if ((_b = (_a = this.connectionInfo) === null || _a === void 0 ? void 0 : _a.extraInfo) === null || _b === void 0 ? void 0 : _b.is_stream) {
    ...
    getDefaultPromptPrefix() {
        ...
        if (extraConnectionInfo === null || extraConnectionInfo === void 0 ? void 0 : extraConnectionInfo.is_data_federation) {
            ...
            ((_d = (_c = (_b = this.connectionInfo) === null || _b === void 0 ? void 0 : _b.buildInfo) === null || _c === void 0 ? void 0 : _c.modules) === null || _d === void 0 ? void 0 : _d.indexOf('enterprise')) >= 0) {
            return 'Enterprise';
        }
        return '';
    }
    getTopologySpecificPrompt() {
        ...
        switch (description.type) {
            ...
            case 'ReplicaSetWithPrimary':
                ...
                break;
            case 'Sharded':
                serverTypePrompt = ((_d = (_c = this.connectionInfo) === null || _c === void 0 ? void 0 : _c.extraInfo) === null || _d === void 0 ? void 0 : _d.atlas_version)
                    ? ''
                    : '[mongos]';
                break;
            case 'LoadBalanced':
