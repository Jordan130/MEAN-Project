...
import { type TimingCategory } from '@mongosh/types';
...
declare class ShellEvaluator<EvaluationResultType = ShellResult> {
    ...
    private asyncWriter;
    private markTime?;
    constructor(instanceState: ShellInstanceState, resultHandler?: ResultHandler<EvaluationResultType>, markTime?: (category: TimingCategory, label: string) => void);
    private innerEval;
